...
public class Main {
    ...
    public static void main(String[] args) throws Exception {
        ...
        while (!abort) {
            System.out.println("Enter master (1), show all (2), show single (3), add (4), delete(5), set new master (6), Abort (0), update single password (7)");
            ...
            switch (input) {
                ...
                case 7:
                    if (locked) {
                        ...
                        PasswordInfo pwi =  new PasswordInfo(newPassword, passwordName);
                        passwordSafeEngine.UpdatePassword(pwi);
                    }
                    break;
                default:
